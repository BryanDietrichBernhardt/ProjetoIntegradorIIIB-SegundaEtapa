...
public class CoLivro implements I_CO {
    ...
    public void excluir() {
        ...
        int resp = JOptionPane.showConfirmDialog(this.getGui(), "Desejas realmente excluir"
                + " este livro?",
                "Cadastrar Livro", JOptionPane.YES_NO_OPTION);
        ...
        try {
            ...
            if (this.getBo().excluir()) {
                JOptionPane.showMessageDialog(this.getGui(), "Livro excluído com sucesso",
                        "Cadastrar Livro", JOptionPane.ERROR_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this.getGui(), this.getBo().getErro(),
                        "Cadastrar Livro", JOptionPane.ERROR_MESSAGE);
    ...
    public void setCampos() {
        ...
        this.getGui().getjTextField3().setText(this.getVo().getAutor());
        // request focus
        this.getGui().getjTextField2().requestFocus();
    }
